...
Hi Guys I m Emo Deckstop Bot...  I m Same for MissRose Bot....
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username))],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/Emo_Bot_industry"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/Emo_Bot_industry")],
                     [InlineKeyboardButton(text="Ower", url="https://t.me/ImRishmika"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))

    else:
        update.effective_message.reply_text("Hi Bro....")
